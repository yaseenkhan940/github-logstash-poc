...
Each event generates a structured log entry in Wazuh dashboard.
Source platform is tagged as github_poc for easy filtering.
Environment is configured as POC for testing purposes.
All events are visible in Wazuh Discover with full event details.
